...
@section('content')
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h1 class="fw-semibold mb-0 body-title">Update Color</h1>
        ...
        <div class="row justify-content-center align-items-center manage-block">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('update-color-post',$color->id)}}" method="POST" class="w-75 mx-auto">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="ratio_price" class="form-control" name="ratio_price" value="{{$color->ratio_price}}">
                                @if ($errors->has('ratio_price'))
                                    <span class='text-danger-login'>{{ $errors->first('ratio_price') }}</span>
                                @endif
                            </div>
                            <div class="form-group mb-3">
                                <button type="submit" class="btn btn-update">Update Color</button>
                            </div>
                        </form>
                    </div>
                </div>
