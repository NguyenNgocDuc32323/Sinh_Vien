...
<div class="dashboard-main-body">
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <h1 class="fw-semibold mb-0 body-title">Cập Nhật Học Sinh</h1>
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <form action="{{route('update-student-post',[$student->id])}}" method="POST" enctype="multipart/form-data" class="w-50 mx-auto">
                                @csrf
                                <div class="form-group mb-3">
                                    ...
                                    <span class="text-danger">{{ $errors->first('student_code') }}</span>
                                    @endif
                                </div>
                                <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" class="form-control" id="birth_day" name="birth_day" value="{{$student->birth_day}}">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control" id="course_id" name="course_id">
                                        ...
                                        <option value="{{ $course->id }}"
                                            {{ $student->course->id == $course->id ? 'selected' : '' }}>
                                            {{ $course->course_name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    <button type="submit" class="btn btn-success">Cập Nhật Học Sinh</button>
                                </div>
                            </form>
                        </div>
                        <div class="tab-pane fade" id="password" role="tabpanel" aria-labelledby="password-tab">
                            <form action="{{route('update-password-student',$student->id)}}" method="POST" class="w-50 mx-auto">
                                @csrf
