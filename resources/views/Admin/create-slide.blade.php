...
@section('content')
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h1 class="fw-semibold mb-0 body-title">Create Slide</h1>
        ...
        <div class="row justify-content-center align-items-center manage-block">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('create-slide-post') }}" method="POST" class="w-75 mx-auto" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                <button type="submit" class="btn btn-update">Create Slide</button>
                            </div>
                        </form>
