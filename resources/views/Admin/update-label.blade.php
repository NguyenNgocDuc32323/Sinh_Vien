...
@section('content')
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h1 class="fw-semibold mb-0 body-title">Update Label</h1>
        ...
        <div class="row justify-content-center align-items-center manage-block">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('update-label-post',$label->id)}}" method="POST" class="w-75 mx-auto">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                <button type="submit" class="btn btn-update">Update Label</button>
                            </div>
                        </form>
                    </div>
                </div>
