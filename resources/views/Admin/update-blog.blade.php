...
@section('content')
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h1 class="fw-semibold mb-0 body-title">Update Blog</h1>
        ...
        <div class="row justify-content-center align-items-center manage-block">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('update-blog-post',$blog->id)}}" method="POST" class="w-75 mx-auto" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                ...
                                style="min-height: 300px; width: 100%;">{{$blog->content}}</textarea>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div>
                                    <img src="{{ asset($blog->image) }}" alt="Blog Image" style="max-width: 300px; max-height: 200px" class="mb-3 mt-3">
                                </div>
