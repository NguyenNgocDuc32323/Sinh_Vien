...
@section('content')
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h1 class="fw-semibold mb-0 body-title">Update Category</h1>
        ...
        <div class="row justify-content-center align-items-center manage-block">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('update-category-post', $category->id) }}" method="POST" class="w-75 mx-auto">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control" id="order_total" name="order_total" value="{{ $category->order_total }}">
                                @if ($errors->has('order_total'))
                                    <span class='text-danger-login'>{{ $errors->first('order_total') }}</span>
                                @endif
                            </div>
                            <div class="form-group mb-3">
