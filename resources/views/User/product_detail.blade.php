...
@section('content')
    ...
    @endif
    <main class="product_detail mt-100">
        <div class="container-fluid">
            <div class="container">
                <div class="row" id="product-{{ $product->id }}">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="detail-img-block d-flex">
                            <div class="img-small-block">
                                <div class="img-small-item">
                                    @foreach ($product->images as $image)
                                        <div class="img-small-slide">
                                            <img src="{{ asset($image) }}" alt="Product Image">
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                            <div class="product-img-large swiper">
                                <div class="swiper-wrapper">
                                    @foreach ($product->image as $image)
                                        <div class="img-large-item swiper-slide">
                                            <img src="{{ asset($image) }}" alt="" class="product-image">
                                        </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="product-infors">
                            @if ($product->label_name)
                                <div class="mb-3"><span class="product-availability">{{ $product->label_name }}</span>
                                </div>
                            @endif
                            ...
                            <div class="product-price-wrapper mb-4">
                                <span class="product-price regular-price"id="product-price-{{ $product->id }}"
                                    data-base-price="{{ $product->price }}">${{ $product->price }}</span>
                                <del class="product-price compare-price ms-2">${{ number_format($product->price * 1.5, 2, '.', '') }}
                                </del>
                            </div>
                            <div class="product-vendor product-meta mb-3">
                                <strong class="label">Category:</strong> <span>{{ $product->category_name }}
                                    Bottles</span>
                            </div>
                            <div class="product-variant-wrapper">
                                <div class="prd-color-title">
                            ...
                            <div class="product-variant-wrapper mt-3">
                                <div class="prd-color-title">
                                    <strong class="label">Sizes:</strong>
                                </div>
                                <ul class="size-variant">
                                    @foreach ($product->sizes_with_prices as $size => $ratio_price)
                                        <li>
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input size-option" id="size_{{ $size }}" name="size" value="{{ $size }}"
                                                    data-product-id="{{ $product->id }}" data-price="{{ $ratio_price }}">
                            ...
                            <div class="misc d-flex align-items-end justify-content-between mt-4">
                                <div class="quantity d-flex align-items-center justify-content-between">
                                    <button class="qty-btn dec-qty"><i class="fa-solid fa-minus"></i></button>
                                    <input class="qty-input" type="text" name="qty" value="1" min="1">
                                    <button class="qty-btn inc-qty"><i class="fa-solid fa-plus"></i></button>
                                </div>
                            </div>
                            <div class="product-form">
                                <div class="product-form-buttons d-flex align-items-center justify-content-between mt-4">
                                    <button type="button" class="position-relative btn-atc btn-add-to-cart loader"
                                        id="{{ $product->id }}" onclick="add_to_cart(this.id)">ADD TO
                                        CART</button>
                                    <button class="btn_wishlist"><i class="fa-regular fa-heart" id="{{ $product->id }}"
                                            onclick="add_wishlist(this.id)"></i></button>
                                </div>
    ...
    <div class="product-tab-section aos-init aos-animate" data-aos="fade-up" data-aos-duration="700">
        <div class="container">
            ...
            <div class="tab-content product-tab-content">
                <div id="pdescription" class="tab-pane fade active show">
                    <div class="row">
                        <div class="col-lg-7 col-md-12 col-12">
                            <div class="desc-content">
                                <h4 class="heading_18 mb-3">Product Description</h4>
                                <p class="text_16 mb-4">Our plastic bottles are designed to offer superior durability and functionality. Made from high-quality, BPA-free materials, these bottles ensure that your liquids remain fresh and uncontaminated. With a variety of sizes and designs, they are perfect for both personal and commercial use. Each bottle is crafted to be leak-proof and easy to use, making them ideal for daily use or travel.</p>
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-12 col-12">
                            <div class="desc-img">
                                <img src="{{asset('images/Dashboard/banner_blog.jpg')}}" alt="Plastic Bottle">
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="desc-content mt-4">
                                <p class="text_16">Our plastic bottles are not only practical but also environmentally conscious. They are fully recyclable and made from sustainable materials. Whether you need them for beverages, personal care products, or household items, these bottles are designed to meet all your needs while minimizing environmental impact.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div id="pshipping" class="tab-pane fade">
                    <div class="desc-content">
                        <h4 class="heading_18 mb-3">Shipping & Returns</h4>
                        <p class="text_16 mb-4">We offer a straightforward shipping and returns policy to ensure a smooth shopping experience. For standard shipping, the cost of return shipping is the responsibility of the customer, but the product price and initial shipping costs will be refunded. For orders with free shipping, the return shipping cost will be borne by the customer, as we covered the initial shipping expense.</p>
                        <p class="text_16 mb-4">If you have received a damaged or defective product, please contact our customer service team for assistance. We will cover the cost of return shipping and arrange for a replacement or refund. We strive to process all returns and exchanges promptly to ensure your satisfaction.</p>
                    </div>
                </div>
                <div id="pstyle" class="tab-pane fade">
                    <div class="desc-content">
                        <h4 class="heading_18 mb-3">Style with</h4>
                        <p class="text_16 mb-4">Our plastic bottles are versatile and can be paired with a variety of accessories and packaging solutions. Consider combining them with our custom labels or decorative caps to enhance their appearance and functionality. They are suitable for use in both residential and commercial settings, making them a great addition to any product lineup.</p>
                        <p class="text_16 mb-4">To make the most of your plastic bottles, we recommend using them with our bottle holders or carrying cases for added convenience. Choose from a range of colors and styles to match your branding or personal preferences. By selecting the right accessories, you can create a cohesive and stylish presentation for your products.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="box swiper-slide" id="product-{{ $relate_product->id }}">
                        ...
                        <div class="cart-info cart-wrap">
                            <a data-toggle="modal" data-target="#modal-cart" title="Add to cart" variant="primary"
                                class="btn-add-to-cart" id="cart-{{ $relate_product->id }}"
                        ...
                        <h2><a href="{{ route('product-detail', $relate_product->id) }}"
                                class="product-title">{{ $relate_product->name }}</a></h2>
...
@push('custom-scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            var swiper = new Swiper(".product-img-large", {
                loop: true,
                autoplay: {
                    delay: 20000,
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let selectedColorPrice = 1;
            let selectedSizePrice = 1;

            colorOptions.forEach(function(option) {
                option.addEventListener('click', function() {
                    const productId = option.getAttribute('data-product-id');
                    selectedColorPrice = parseFloat(option.getAttribute('data-price'));
                    selectedColor = option.getAttribute('data-color');

                    updatePrice(productId);
                    document.querySelectorAll(`#product-${productId} .color-option`).forEach(function(opt) {
            ...
            sizeOptions.forEach(function(option) {
                option.addEventListener('click', function() {
                    const productId = option.getAttribute('data-product-id');
                    selectedSizePrice = parseFloat(option.getAttribute('data-price'));
                    selectedSize = option.value;

                    updatePrice(productId);
                    document.querySelectorAll(`#product-${productId} .size-option`).forEach(function(opt) {
                        opt.classList.remove('selected');
                    });
            ...
            function updatePrice(productId) {
                ...
                const basePrice = parseFloat(basePriceElement.getAttribute('data-base-price')) || 1;
                const newPrice = (basePrice * selectedColorPrice * selectedSizePrice).toFixed(2);
                ...
                if (productElement) {
                    productElement.setAttribute('data-selected-price', newPrice);
                    productElement.setAttribute('data-selected-color', selectedColor);
                    productElement.setAttribute('data-selected-size', selectedSize);
                }
            }
        });
        ...
        function add_wishlist(clicked_id) {
            ...
            var nameElement = productElement.querySelector('.product-title');
            var name = nameElement ? nameElement.innerText : 'No name';
            var selectedPrice = productElement.getAttribute('data-selected-price');
            var selectedColor = productElement.getAttribute('data-selected-color');
            var selectedSize = productElement.getAttribute('data-selected-size');

            if (!selectedColor || !selectedSize) {
                toastr.error('PLEASE SELECT BOTH COLOR AND SIZE');
                return;
            }
            ...
            var itemIndex = old_data.findIndex(function(obj) {
                return obj.id == id && obj.color == selectedColor && obj.size == selectedSize;
            });
            ...
            if (itemIndex !== -1) {
                ...
                $('#wishlist_list').find(`[data-index="${id}-${selectedColor}-${selectedSize}"]`).remove();
                ...
                $('#wishlist_list').append(`
                    <li class="media d-flex align-items-center" data-index="${id}-${selectedColor}-${selectedSize}">
                        ...
                        <div class="media-body media-middle">
                            <button class="btn-remove-wishlist" onclick="removeFromWishlist('${id}-${selectedColor}-${selectedSize}')">
        ...
        //qty
        document.addEventListener('DOMContentLoaded', function() {
            const decButton = document.querySelector('.dec-qty');
            const incButton = document.querySelector('.inc-qty');
        ...
        function add_to_cart(clicked_id) {
            ...
            var basePrice = basePriceElement ? parseFloat(basePriceElement.getAttribute('data-base-price') || basePriceElement.innerText.replace('$', '')) : 0;
            var selectedPrice = productElement.getAttribute('data-selected-price');
            var price = selectedPrice ? parseFloat(selectedPrice) : basePrice;

            var qtyInput = productElement.querySelector('.qty-input');
            ...
            var color = productElement.getAttribute('data-selected-color') || 'White';
            var size = productElement.getAttribute('data-selected-size') || 'M';
            var newItem = {
                id: id,
                image: image,
                name: name,
            ...
            var itemIndex = old_data.findIndex(function(obj) {
                return obj.id == id && obj.color == newItem.color && obj.size == newItem.size; // Check size as well
            });

            if (itemIndex !== -1) {
                var newQuantity = old_data[itemIndex].quantity + quantity;
                if (newQuantity > 1000) {
                    toastr.error('Cannot exceed 1000 items!');
                    return;
                }
                old_data[itemIndex].quantity = newQuantity;
        ...
        function removeFromCart(idColor) {
            ...
            if (cart) {
                try {
                    ...
                    localStorage.setItem('cart', JSON.stringify(old_data));
                    document.querySelector(`#cart_list [data-index="${idColor}"]`).remove();
                    var [id, color] = idColor.split('-');
